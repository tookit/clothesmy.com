...
namespace Michaelwang\Mediable;

use Illuminate\Contracts\Filesystem\Filesystem;
use Illuminate\Filesystem\FilesystemManager;
use Michaelwang\Mediable\Exceptions\MediaUpload\ConfigurationException;
use Michaelwang\Mediable\Exceptions\MediaUpload\FileExistsException;
use Michaelwang\Mediable\Exceptions\MediaUpload\FileNotFoundException;
use Michaelwang\Mediable\Exceptions\MediaUpload\FileNotSupportedException;
use Michaelwang\Mediable\Exceptions\MediaUpload\FileSizeException;
use Michaelwang\Mediable\Exceptions\MediaUpload\ForbiddenException;
use Michaelwang\Mediable\Helpers\File;
use Michaelwang\Mediable\SourceAdapters\RawContentAdapter;
use Michaelwang\Mediable\SourceAdapters\SourceAdapterFactory;
...
class MediaUploader
{
    ...
    /**
     * Source adapter.
     * @var \Michaelwang\Mediable\SourceAdapters\SourceAdapterInterface
     */
    private $source;
     ...
     * @param string $class
     * @return $this
     * @throws ConfigurationException if $class does not extend Michaelwang\Mediable\Media
     */
