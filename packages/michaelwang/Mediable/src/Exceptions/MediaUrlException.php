...
namespace Michaelwang\Mediable\Exceptions;
...
class MediaUrlException extends Exception
{
    ...
    {
        return new static("Could not set UrlGenerator, class `{$class}` does not extend `Michaelwang\Mediable\UrlGenerators\UrlGenerator`");
    }
}
