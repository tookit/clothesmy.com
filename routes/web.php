...
Route::get('/search','Web\SearchController@index')->name('product.search');
...
Route::get('/news','Web\NewsController@index')->name('news.view');
Route::get('/news/item/{slug}','Web\NewsController@view')->name('news.view');
Route::get('/news/category/{slug}','Web\NewsController@category')->name('news.category');
Route::get('/tag/{slug}','Web\TagController@view')->name('tag.view');
